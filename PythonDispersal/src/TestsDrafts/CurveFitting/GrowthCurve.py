...
df = pd.read_csv("C:/Users/Ruth/ownCloud/DisperalSimulationOutput/Testing/13383_slp0_Rsk0.3_K300_var0_dslm1.2_maxOff6.py.csv")
...
NNPlusOne = NNPlusOne.sort_values(by ='num_adsB4_dispersal')
...
params.add('a', value=8.4, vary=True)
params.add('b', value=2, vary=True)

## possible methods = https://lmfit.github.io/lmfit-py/fitting.html

result = fmodel.fit(rdata, params, N=Ndata, method = 'nelder')
...
#plt.plot(Ndata, growth_func(N=Ndata, **result.values) )
