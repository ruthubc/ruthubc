...
ggplot(aveFile, aes(x = Comp_meas, y = log10(metPopAgeMax))) + 
		...
		scale_shape_discrete(Label_dspSizeLegend, breaks = disBreaks, labels = disNewLab) + scale_linetype_discrete(Label_dspSizeLegend, breaks = disBreaks, labels = disNewLab) + 
		xlab(Label_compAxis) +
