...
ggplot(subDispFile, aes(x = log10(survivalMean_all), y = log10(Comp_meas), colour = as.factor(ad_dsp_fd))) +
...
ggplot(importDispFile, aes(x = as.factor(Comp_meas), y = as.factor(ad_dsp_fd), fill = any_disp))  + geom_tile() +
