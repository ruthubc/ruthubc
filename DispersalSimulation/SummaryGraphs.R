...
png("DisperalSimulationOutput/DispersalSummaryGraphs07Jan.png", width = 1300, height = gr_ht, units = "px")
...
dis_aves <- read.csv(paste(folder, "DisSum_OriComp_50Gens_7Jan.csv", sep = ""))
