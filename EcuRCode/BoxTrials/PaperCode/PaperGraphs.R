...
pdf("RuthEcuador2013/BoxFeedingTrials/Graphs/PaperGraphsSept17.pdf", width =10, height =10, unit)
...
#   + scale_fill_manual("FeedIndPos", values = c("darkgrey", "lightgrey")) 
...
ggplot(AveFdOrCap, aes(x = Treatment, y = PropCheat)) + stat_summary(fun.y=mean, colour="red", geom="point") + ylim(0, 1)
