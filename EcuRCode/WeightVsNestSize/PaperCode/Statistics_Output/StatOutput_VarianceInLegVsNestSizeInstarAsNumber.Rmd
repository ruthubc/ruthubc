...
TestInteraction <- c("Testing the interaction", lmer(relativeVar ~ logCtFm + (1|NestID), data = dataset, REML = FALSE, weight = lmrWgts))
TestNS <- c("Testing NestSize", lmer(relativeVar ~ (1|NestID), data = dataset, REML = FALSE, weight = lmrWgts))


RedModels <- list(TestInteraction, TestNS)
