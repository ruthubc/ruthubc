...
finalModel <- "logLeg ~ logCtFm + InstarNumber + logCtFm:InstarNumber + InstarNumber:InstarSex + (1 | NestID)"
...
InstarGridGraph(dataset, "logLeg", "Leg Length - log transformed", model = final_lmer)
