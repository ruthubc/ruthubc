...
$\chi$^2^~`r InstarSexCondRes[['df']]`~ = `r InstarSexCondRes[['chi2']]`, p
`r InstarSexCondRes[['P']]` `r InstarSexCondRes[['stars']]`), 
...
condBootVar$bootSD_varProp <- condBootVar$bootSD_var/100

InstarGridGraph(condBootVar, "bootSD_varProp", "Variance in Condition", model = varBootCondMod, "y")
