...
condBootVar$bootVarTrans <- asin(condBootVar$condUniform)

dataset <- condBootVar

ggplot(dataset, aes(condUniform)) + geom_histogram()

ggplot(dataset, aes(log(condUniform))) + geom_histogram()

ggplot(dataset, aes(exp(condUniform))) + geom_histogram()
ggplot(dataset, aes(1/(condUniform))) + geom_histogram()

ggplot(dataset, aes(asin(condUniform))) + geom_histogram()

ggplot(dataset, aes(bootVarTrans)) + geom_histogram()
...
myFormula <- bootVarTrans ~ logCtFm + InstarNumber + InstarNumber:InstarSex + logCtFm:InstarNumber + 
