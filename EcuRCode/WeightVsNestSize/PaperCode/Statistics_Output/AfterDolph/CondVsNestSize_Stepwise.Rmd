...
#myFormula <- condResiduals ~ logCtFm + InstarNumber + InstarNumber:InstarSex + logCtFm:InstarNumber + logCtFm:InstarNumber:InstarSex + 
...
cat("Model:", as.character(finalModel@call[2]), sep = '\n')

InstarGridGraph(dataset, "condResiduals", "Condition", model = finalModel)
