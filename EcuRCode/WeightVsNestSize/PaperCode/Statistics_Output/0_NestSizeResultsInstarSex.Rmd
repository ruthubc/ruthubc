...
```
The model with the lowest AIC included colony size and instar x colony size interaction, but not instar sex.
Colony size combined with the nest size x instar interaction was significant (lmer; $\chi$^2^~`r NSResults[[1]]`
