...
```{r Flow, fig.height=5, fig.width=6}
...
```{r Paper, fig.height=4, fig.width=4.5}
...
```{r Topic, fig.height=5, fig.width=5}
...
```{r Narration, fig.height=4, fig.width=4.5}
...
```{r SlideInfo, fig.height=4, fig.width=4}
